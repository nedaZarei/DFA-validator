...
public class DFAvalidator {
    ...
    public DFAvalidator(String inputFile) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(inputFile))) {
            ...
            for(int i = 0; i<number_of_machines; i++){
                ...
                */
                ...
                if(i!=12) reader.readLine(); //reads enter at the end of each machine
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public boolean validateString(int machineNumber, String input) {
        ...
        for (int i = 0; i < input.length(); i++) {
            ...
            boolean validTransitionExists = false;
        ...
        for(String item : finalStates.get(machineNumber)){ //searching in finalState array for this machine
    ...
    public static void main(String[] args) {
        ...
        System.out.println("enter the absolute path of your DFA input file :");
        String inputFile = input.nextLine();

        DFAvalidator validator = new DFAvalidator(inputFile);
